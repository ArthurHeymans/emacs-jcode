...
(defface jcode-text-face '((t :foreground "#c8c8c3")) "Native jcode body text face." :group 'jcode)
...
(defface jcode-user-face '((t :inherit jcode-heading-2-face)) "User heading face." :group 'jcode)
(defface jcode-assistant-face '((t :inherit jcode-heading-1-face)) "Assistant heading face." :group 'jcode)
(defface jcode-tool-face '((t :inherit jcode-strong-face :slant italic)) "Tool name/header face." :group 'jcode)
(defface jcode-tool-block-face '((t :background "#202025" :extend t)) "Subtle face for tool block backgrounds." :group 'jcode)
